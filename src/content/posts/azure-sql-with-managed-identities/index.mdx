...
<ImageHeading
  ...
  imageSrc="/src/assets/icons/azure-sql-database.png"
  imageAlt="Azure SQL Database icon"
/>
...
<ImageHeading
  ...
  imageSrc="/src/assets/icons/managed-identity.png"
  imageAlt="Managed identity icon"
/>
