...
<ImageHeading text="Azure SQL Database" imageSrc={azureSqlIcon} imageAlt="Azure SQL Database icon" />
...
<ImageHeading text="Managed identities" imageSrc={managedIdentityIcon} imageAlt="Managed identity icon" />
