...
heroImage:
  src: 'azure-sql-with-managed-identities.png'
  alt: Abstract Azure SQL Database icon with managed identities concept
category: 'guide'
...
import azureSqlIcon from '@/assets/icons/azure-sql-database.png';
import managedIdentityIcon from '@/assets/icons/managed-identity.png';
...
<Image src={azureSqlIcon} alt="Azure SQL Database icon" width={96} height={96} class="not-prose mx-auto" />
...
<Image src={managedIdentityIcon} alt="Managed identity icon" width={96} height={96} class="not-prose mx-auto" />
