...
<ImageHeading text="Frontend - Angular" headingTag="h3" imageSrc={angularLogo} imageAlt="Angular logo" />
...
<ImageHeading text="Database - Azure SQL Database" headingTag="h3" imageSrc={azureSqlLogo} imageAlt="Azure SQL logo" />
...
<ImageHeading
  text="Deployment - GitHub Actions"
  headingTag="h3"
