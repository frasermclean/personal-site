...
description: An introduction to my new project, RateMyPet - a social site for pet lovers to share and rate pet photos and stories.
publishDate: 2025-05-17T09:12:19+08:00
heroImage:
  src: introducing-ratemypet.jpg
  alt: Photo of a corgi dog looking happy outdoors
comments: true
category: project
...
import azureSqlLogo from '@/assets/icons/azure-sql-database.png';
import githubActionsLogo from '@/assets/icons/github-actions.png';
import { Image } from 'astro:assets';

## Introduction

For the past few months, I've been working on a new pet project (excused the pun 😂), called [RateMyPet](https://ratemy.pet). It's a social site where users can share photos and stories about their pets, and rate each other's pets. The idea is to create a fun and engaging community for pet lovers.

It's been a challenging but rewarding experience, and I'm excited to share it with you.

![Welcome page](ratemypet-welcome.png)
...
![Latest posts](ratemypet-posts.png)
...
<Image src={angularLogo} alt="Angular logo" width={96} height={96} class="mx-auto" />
...
<Image src={azureSqlLogo} alt="Azure SQL logo" width={96} height={96} class="mx-auto" />
...
<Image src={githubActionsLogo} alt="GitHub Actions logo" width={96} height={96} class="mx-auto" />
...
![Application architecture diagram](ratemypet-architecture.png)
