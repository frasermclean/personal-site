...
heroImage: 
  src: coder-multi-monitor.jpg
  alt: Computer programmer sitting at a desk with multiple monitors displaying code
...
![DefaultAzureCredential sequence](default-azure-credential-flow.png)
