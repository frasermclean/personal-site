...
heroImage: 
  ...
  alt: Abstract analytics art with privacy concept
category: guide
...
![Postgres ready to accept connections](postgres-ready.png)
...
If everything went well, you should see a page similar to the following: ![Plausible Analaytics registration page](plausible-register.png)
