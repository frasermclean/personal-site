...
export function initCarousel(carouselElement: HTMLElement, options: CarouselOptions = {}): CarouselManager | null {
  ...
  const prevButton = carouselElement.querySelector('[data-slot="carousel-previous"]') as HTMLButtonElement;
  const nextButton = carouselElement.querySelector('[data-slot="carousel-next"]') as HTMLButtonElement;
