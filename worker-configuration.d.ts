/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 627c7caec6950df7b8f66a990535e418)
// Runtime types generated with workerd@1.20260507.1 2026-05-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		SESSION: KVNamespace;
		ASSETS: Fetcher;
		COMMENTS_HOST: "https://comments.frasermclean.com";
		TURNSTILE_SITE_KEY: "0x4AAAAAAAhX2PdPqj0Cojk1";
		CONTACT_EMAIL: string;
		RESEND_API_KEY: string;
		TRACKING_WEBSITE_ID: string;
		TRACKING_SCRIPT_SRC: string;
		WEBMENTION_API_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "COMMENTS_HOST" | "TURNSTILE_SITE_KEY" | "CONTACT_EMAIL" | "RESEND_API_KEY" | "TRACKING_WEBSITE_ID" | "TRACKING_SCRIPT_SRC" | "WEBMENTION_API_KEY" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GITHUB_REDIRECT_URI">> {}
}
